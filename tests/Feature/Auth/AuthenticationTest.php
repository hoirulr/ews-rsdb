...
class AuthenticationTest extends TestCase
{
    ...
    public function test_inactive_users_are_logged_out_from_active_sessions(): void
    {
        $user = User::factory()->create(['is_active' => false]);
    ...
    public function test_admin_rsud_users_are_redirected_to_igd_dashboard(): void
    {
        ...
        $user = User::factory()->create();
        $user->assignRole('admin_rsud');

        $response = $this->actingAs($user)->get('/dashboard');

        $response->assertRedirect(route('igd.dashboard', absolute: false));
    }
